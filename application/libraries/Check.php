...
class Check {
     ...
     */
    public static function Image($ImageUrl, $ImageDesc = 'Sem Imagem', $ImageW = null, $ImageH = null, $class = null) {
        self::$Data = $ImageUrl;
        if (file_exists(self::$Data) && !is_dir(self::$Data)):
            $patch = base_url();
            $imagem = self::$Data;
            return "<img class=\"{$class}\" src=\"{$patch}/{$imagem}\" alt=\"{$ImageDesc}\" title=\"{$ImageDesc}\"/>";
        else:
    ...
    /**
     * <b>tipoUsuarioDescricao</b> Retorna o tipo de Usuário de acordo com o tipo
     */
